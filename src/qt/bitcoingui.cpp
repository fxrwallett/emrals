    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Emrals Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Emrals address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and emrals: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Emrals Core"), this);
    aboutAction->setStatusTip(tr("Show information about Emrals Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Emrals Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Emrals addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Emrals addresses"));
    ...
    openAction->setStatusTip(tr("Open a emrals: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Emrals Core help message to get a list with possible Emrals Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Emrals Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Emrals network", "", count));
    } else {
...
{
    QString strTitle = tr("Emrals Core"); // default title

    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("EMRALS-light"), QVariant("light"));
    ui->theme->addItem(QString("EMRALS-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("EMRALS-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("EMRALS-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("EMRALS-traditional"), QVariant("trad"));

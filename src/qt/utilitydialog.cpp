    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Emrals Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Emrals Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  emrals-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Emrals in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 EMRALS, 0.1 EMRALS, 1 EMRALS and 10 EMRALS -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://emralspay.atlassian.net/wiki/display/DOC/PrivateSend\">https://emralspay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Emrals Core is shutting down...") + "<br /><br />" +

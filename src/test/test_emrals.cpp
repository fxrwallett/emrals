...
#define BOOST_TEST_MODULE Emrals Test Suite

#include "test_emrals.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_emrals_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));

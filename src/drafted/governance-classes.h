 ...
 *
 *   // network
 *   CEmralsNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.emrals.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CEmralsNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: EmralsNetwork
// //   -- signature requirements : Key1(User)
// class CEmralsNetworkVariable : public CGovernanceObject
// {
// private:

...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "EmralsNetwork") type = EmralsNetwork;
    if(strType == "EmralsNetworkVariable") type = EmralsNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == EmralsNetwork) s = "EmralsNetwork";
    if(type == EmralsNetworkVariable) s = "EmralsNetworkVariable";

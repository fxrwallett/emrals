...
Only requiring some minor changes is emrals.cpp.
...
Changes to emrals.cpp
----------------------
emrals.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for

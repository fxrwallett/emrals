...
This mechanism has been integrated into Bitcore-Node-Emrals which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/emralspay/insight-api-emrals#web-socket-api](https://github.com/emralspay/insight-api-emrals#web-socket-api)
* API: [https://github.com/emralspay/insight-api-emrals#instantsend-transactions](https://github.com/emralspay/insight-api-emrals#instantsend-transactions)
...
By default, the Emrals Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Emrals Core daemon:

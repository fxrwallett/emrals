...
cp $TRAVIS_BUILD_DIR/src/qt/emrals-qt $OUTDIR/bin/ || cp $TRAVIS_BUILD_DIR/src/qt/emrals-qt.exe $OUTDIR/bin/ || echo "no QT Wallet"
cp $TRAVIS_BUILD_DIR/src/emralsd $OUTDIR/bin/ || cp $TRAVIS_BUILD_DIR/src/emralsd.exe $OUTDIR/bin/
cp $TRAVIS_BUILD_DIR/src/emrals-cli $OUTDIR/bin/ || cp $TRAVIS_BUILD_DIR/src/emrals-cli.exe $OUTDIR/bin/
